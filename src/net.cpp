...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitmea " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitmea.com", "node1.bitmea.com"},
    {"bitmea.com", "node2.bitmea.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitmea is probably already running."), addrBind.ToString().c_str());
        else
